...
- *lab*: eXplainable Artificial Intelligence (XAI) - wstęp, czyli co to takiego?

2021-03-04
- *projekt*:  Teoretyczny wstęp do Machine Learning.
- *lab*: Praktyczny wstęp do Machine Learning.

2021-03-11
- *projekt*:  Omówienie tematów projektów.
- *lab*: Metoda Break Down oraz Shapley values.

2021-03-18
- *projekt*: Planowanie pracy nad projektem, jak efektywnie pracować w grupie, podział zadań i sposób weryfikacji rezultatów.
- *lab*: Omówienie pracy domowej 1.


Kolejne terminy oraz tematy zostaną dodane później.
